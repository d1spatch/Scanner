...
package com.google.zxing.testcode.encoder;
...
import static com.google.zxing.qrcode.decoder.Mode.ALPHANUMERIC;
import static com.google.zxing.qrcode.decoder.Mode.BYTE;
import static com.google.zxing.qrcode.decoder.Mode.KANJI;
import static com.google.zxing.qrcode.decoder.Mode.NUMERIC;
...
public final class Encoder {
   ...
   */
  public static TestCode encode(String content, ErrorCorrectionLevel ecLevel) throws WriterException {
  ...
  public static TestCode encode(String content,
    ...
    testCode.setECLevel(ecLevel);
    testCode.setMode(mode);
    testCode.setVersion(version);

    //  Choose the mask pattern and set to "qrCode".
    int dimension = version.getDimensionForVersion();
    ByteMatrix matrix = new ByteMatrix(dimension, dimension);
    int maskPattern = chooseMaskPattern(finalBits, ecLevel, version, matrix);
    testCode.setMaskPattern(maskPattern);

    // Build the matrix and set it to "qrCode".
    MatrixUtil.buildMatrix(finalBits, ecLevel, version, maskPattern, matrix);
    testCode.setMatrix(matrix);
